...
<div class="divdialog">
	...
	<form name="form" id="form" action="${ctx}/background/dicType/update.html" method="post">
		<table style="width: 285px; height: 200px;">
			<tbody>
				<tr>
					<td class="l_right">Key：</td>
					<td class="l_left">
					<input id='id' name="id" type="hidden" value="${dicType.id}">
					<input id='dicTypeKey' name="dicTypeKey" type="hidden" value="${dicType.dicTypeKey}">
					${dicType.dicTypeKey}</td>
				</tr>
				<tr>
					...
					<input id='dicTypeName'
						name="dicTypeName" type="text" value="${dicType.dicTypeName}">
						</div>
						</td>
				</tr>
				<tr>
					...
					<input id='description'
						name="description" type="text" class="checkdesc" value="${dicType.description}">
						</div>
						</td>
				</tr>
				<tr>
